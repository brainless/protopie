...
- See [`evals/README.md`](evals/README.md) for the actual `evals record`/`evals test` CLI, fixture creation, and recording workflow — don't guess CLI flags from this file or `DEVELOP.md`, they defer to the crate's own doc.
